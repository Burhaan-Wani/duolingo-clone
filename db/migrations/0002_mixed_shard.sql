...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "challengesOptions" (
	"id" serial PRIMARY KEY NOT NULL,
	"challenge_id" integer,
	"text" text NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "challengesOptions" ADD CONSTRAINT "challengesOptions_challenge_id_challenges_id_fk" FOREIGN KEY ("challenge_id") REFERENCES "public"."challenges"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
